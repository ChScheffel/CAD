On the 6th of February 2023, we downloaded the REDCap data as a .csv file to make some changes to the otherwise protected data fields.
...
3. Answers that were collected on paper due to technical failures or misunderstandings during the session were put into the respective cells (demographic questionnaire, NASA-TLX, follow-up T2).
...
This edited data file will now be re-uploaded into REDCap with a csv called "Questionnaire_Data_Edits.csv".
Then, a complete file containing both the original and the edited data will be downloaded from REDCap, called "Questionnaire_Data_Full_Version.csv".
