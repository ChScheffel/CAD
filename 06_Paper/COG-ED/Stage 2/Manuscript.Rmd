...
To investigate the dependency of the model results on the RT preprocessing, we conducted a specification curve analysis.

INSERT FIGURE 2 HERE

```{r sca-plot, echo = FALSE, message = FALSE, warning = FALSE, fig.cap = "Results of the multi level model for each of the 63 preprocessing pipelines. The lower panel indicates the type of preprocessing, the middle panel shows the p-value of the full model, and the upper panel the beta coefficient as a line and its standard deviation as a vertical box. The colourbar indicates the BF10.", fig.pos="H"} 
