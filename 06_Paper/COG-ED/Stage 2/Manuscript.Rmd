...
The performance measure *d’* did not change across *n*-back levels (`r apa_print(hypothesis1a_rmanova)$full_result$level`), but the median RT did (`r apa_print(hypothesis1b_rmanova)$full_result$level`).
