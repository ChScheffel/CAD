...
abstract: |
  ...
  Participants with higher Need for Cognition scores perceived higher levels as less effortful and found them less aversive.
...
Instead of the 72 subjects stated above, the largest minimum sample size was actually 53 subjects (see hypothesis 1b in the **Design Table**).
...
However, effort-related traits such as NFC suggest that this is not the case.
...
Participants with NFC scores above the median reported lower subjective task load in and less aversion to more difficult levels.
...
The CAD paradigm offers this flexibility, and we encourage future studies to question traditional assumptions in the field of effort discounting in the light of these findings.
