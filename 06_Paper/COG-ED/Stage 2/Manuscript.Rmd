...
We used an ANOVA to compare the fit of the final model with a linear random intercept model.
The two models were different from each other ($\chi^2(`r compare_h2b$Df[2]`)=compare_h2b$Chisq[2]$, $p<.001$), and with an Akaike Information Criterion of $AIC=`r compare_h2b$AIC[2]`$ and a Bayesian Information Criterion of $BIC=`r compare_h2b$BIC[2]`$ the declining logistic model is superior to the linear model ($AIC=`r compare_h2b$AIC[1]`$, $BIC=`r compare_h2b$BIC[1]`$).
