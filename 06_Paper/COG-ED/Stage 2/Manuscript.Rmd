...
The effect estimates of the *n*-back level varied by about `r format(round(diff(range(sca_results$beta_n)), digits = 3), digits = 3)`, those of *d'* by about `r format(round(diff(range(sca_results$beta_d)), digits = 3), digits = 3)`.
