...
```{r motivation, echo=FALSE, message=FALSE, warning=FALSE, fig.cap="Subjective values per $n$-back level for each participant, grouped by the motivation for effort discounting that they indicated in the single choice question after the paradigm. $N=116$. 'Other' opened up a free text field, in which participants gave responses such as 'I wanted fair pay for my effort', 'I wanted to have fun', and 'I wanted to maximize the reward'. Figure available at osf.io/vnj8x/, under a CC-BY-4.0 license.", fig.pos="H"} 
