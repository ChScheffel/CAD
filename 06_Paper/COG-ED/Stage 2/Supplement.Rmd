---
title             : "Supplementary Material for the Registered Report titled: 'When easy is not preferred: A discounting paradigm to assess load-independent task preference'"
...
## Motivations for effort discounting behaviour

```{r motiv-plot, echo=FALSE, message=FALSE, warning=FALSE, fig.cap="Subjective values per $n$-back level for each participant, grouped by the motivation for effort discounting that they indicated in the single choice question after the paradigm. $N=116$", fig.pos="H"} 
...
apa_table(
  ...
  caption = "Paired contrast for the rmANOVA comparing the influence of Need for Cognition group and $n$-back level on subjectvie values.",
