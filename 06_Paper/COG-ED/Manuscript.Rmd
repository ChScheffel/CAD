...
<!-- wouldn't it be more intellegible if the following code chunks are placed where the respective analyses are introduced/commented on? -->
...
The individual degree of ED in the study by Westbrook et al. [-@Westbrook2013] was also associated with the participants' scores in Need for Cognition (NFC), a personality trait describing individuals who actively seek and enjoy effortful cognitive activities [@Cacioppo1982].
...
Each hypothesis is detailed in the Design Table in the Appendix. <!-- regarding the Design Table, I have some questions, especially regarding the effect sizes used, they seem unusually large -->
...
A sample size analysis with *G\*Power* [@Faul2007; @Faul2009], based on the results of the ANOVA of Westbrook et al. [-@Westbrook2013] which showed an increase in reaction time with higher *n*-back levels, indicated that we should collect data from at least 53 participants, assuming $\eta2=0.04$, $\alpha=.05$, and $\beta=.95$. <!-- but can we really rely on Westbrook et al., 2013, when we know the findings of Kramer et al., 2021, who observed only half of the originally reported effect size, and quite rightfully so, because initiallly reported effect sizes are more likely thasn not inflated -->
...
<!-- werden wie Korrelationskoeffizienten interpretiert (https://doi.org/10.1186/s40536-018-0061-2), könnten wir im Ergebnisteil demnach in der Größe einschätzen --->
...
As effect size measures, we calculate pseudo *R²* for our model and *f²* to estimate the effects of n-back level and NFC according to <!-- please add https://doi.org/10.1186/s40536-018-0061-2 -->.  
