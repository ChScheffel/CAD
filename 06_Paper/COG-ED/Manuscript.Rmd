...
```{r Hypothesis_1a, echo=FALSE, message=FALSE, warning=FALSE}
  ...
  # FIXME:  actually, I guess, we have a MANOVA here as we look at repeated measures of a subject's reaction time 
  #         under different load levels (= time points)
  
      # make a temporary copy of the dprime data frame without 1-back
      
      h1a_data <- dprime[dprime$level != 1,]      # Westbrook et al. exclude level 1, do you understand why?
  ...
  # FIXME:  actually, I guess, we have a MANOVA here as we have repeated measures of a subject's reaction time 
  #         under different load levels (= time points)
      ...
      hypothesis1a_Manova <- ezANOVA(h1a_data, dv = d, wid = subject, within = level, type = 3, return_aov = T) 
      ...
      hypothesis1a_emm <- emmeans(hypothesis1a_Manova$aov, ~ level) 
