    ...
    if (pipeline_name[[1]][1] == "A" & pipeline_name[[1]][2] == "A") {
        ...
        for (x in 1:4) {
            ...
            if (pipeline_name[[1]][4] == "2") {
              ...
              pipelines_data[[i]] <-
                pipelines_data[[i]][((pipelines_data[[i]]$level == x) & (pipelines_data[[i]]$rt < (pipemean + 2 * pipesd))
                                           & (pipelines_data[[i]]$rt > (pipemean - 2 * pipesd))) | (pipelines_data[[i]]$level != x), ]
                  
            } else if (pipeline_name[[1]][4] == "3") {
              
              pipelines_data[[i]] <-
                pipelines_data[[i]][((pipelines_data[[i]]$level == x) & (pipelines_data[[i]]$rt < (pipemean + 3 * pipesd))
                                           & (pipelines_data[[i]]$rt > (pipemean - 3 * pipesd))) | (pipelines_data[[i]]$level != x), ]
            }
        }
        ...
        for (x in 1:4) {
          ...
          for (y in 1:length(table(pipelines_data[[i]]$subject))) {
            ...
            if (pipeline_name[[1]][4] == "2") {
              ...
              pipelines_data[[i]][which(pipelines_data[[i]]$level == x & pipelines_data[[i]]$subject == pipesubject), ] <-
                pipelines_data[[i]][which(pipelines_data[[i]]$level == x & pipelines_data[[i]]$subject == pipesubject)
                                    [which(pipelines_data[[i]]$rt[pipelines_data[[i]]$level == x
                                                                  & pipelines_data[[i]]$subject == pipesubject] < (pipemean + 2 * pipesd)
                                           & pipelines_data[[i]]$rt[pipelines_data[[i]]$level == x
                                                                    & pipelines_data[[i]]$subject == pipesubject] > (pipemean - 2 * pipesd))], ]
              ...
              pipelines_data[[i]][which(pipelines_data[[i]]$level == x & pipelines_data[[i]]$subject == pipesubject), ] <-
                pipelines_data[[i]][which(pipelines_data[[i]]$level == x & pipelines_data[[i]]$subject == pipesubject)
                                    [which(pipelines_data[[i]]$rt[pipelines_data[[i]]$level == x
                                                                  & pipelines_data[[i]]$subject == pipesubject] < (pipemean + 3 * pipesd)
                                           & pipelines_data[[i]]$rt[pipelines_data[[i]]$level == x
                                                                    & pipelines_data[[i]]$subject == pipesubject] > (pipemean - 3 * pipesd))], ]
            }
          }
      ...
      # apply the transformations and exclusions within subjects but across levels
        ...
        for (y in 1:length(table(pipelines_data[[i]]$subject))) {
            ...
            if (pipeline_name[[1]][4] == "2") {
              ...
              pipelines_data[[i]][which(pipelines_data[[i]]$subject == pipesubject), ] <-
                pipelines_data[[i]][which(pipelines_data[[i]]$subject == pipesubject)
                                    [which(pipelines_data[[i]]$rt[pipelines_data[[i]]$subject == pipesubject] < (pipemean + 2 * pipesd)
                                           & pipelines_data[[i]]$rt[pipelines_data[[i]]$subject == pipesubject] > (pipemean - 2 * pipesd))], ]    
            } else if (pipeline_name[[1]][4] == "3") {
              
              pipelines_data[[i]][which(pipelines_data[[i]]$subject == pipesubject), ] <-
                pipelines_data[[i]][which(pipelines_data[[i]]$subject == pipesubject)
                                    [which(pipelines_data[[i]]$rt[pipelines_data[[i]]$subject == pipesubject] < (pipemean + 3 * pipesd)
                                           & pipelines_data[[i]]$rt[pipelines_data[[i]]$subject == pipesubject] > (pipemean - 3 * pipesd))], ]
            }
        }
