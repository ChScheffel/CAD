...
As there was no prior evidence on the magnitude of an interaction between *n*-back level and NFC, we assumed a small to medium effect size of $f=.175$.
Sample size analysis with *G\*Power* [@Faul2007; @Faul2009] for a repeated measures ANOVA with within-between interaction indicated that we should collect data from at least 72 participants, assuming $\alpha=.05$ and $\beta=.95$.
