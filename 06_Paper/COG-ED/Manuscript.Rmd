...
After each level, participants filled out the NASA-TLX questionnaire [@Hart1988] on a tablet to assess their perceived task load.
...
Two days after the second session, participants received a link to the personality questionnaires (only the NFC scale [@Bless1994; @Cacioppo1984] was analyzed in the present study, the full list of questionnaires can be found in Appendix 1).
Participants received 8€ per hour, about 30€ in total, or course credit for participation.
