  ...
  for (i in 1:length(pipelines_data)) {
    ...
    if (pipeline_name[[1]][1] == "A" & pipeline_name[[1]][2] == "A") {
          ...
          if (pipeline_name[[1]][4] == "2") {
            ...
            pipelines_data[[i]] <- pipelines_data[[i]][c(which(pipelines_data[[i]]$rt < (pipemedian + 2.5 * pipemad)
                                                               & pipelines_data[[i]]$rt > (pipemedian - 2.5 * pipemad))), ]
    ...
    # exclude RTs fast than 100 or 200 ms after stimulus onset if the fourth letter in the data frame name is an "O" or a "T"
    ...
    if (pipeline_name[[1]][4] == "O") {
      ...
      ifelse(nrow(pipelines_data[[i]][-c(which(pipelines_data[[i]]$rt < 0.2)), ]) > 0,
