...
```{r setup, echo=FALSE, message=FALSE, warning=FALSE}
  ...
  renv::init(here("06_Paper","COG-ED"))
  
  # the required packages are:
  # "bibtex", "here", "tidyverse", "bayestestR", "papaja", "lmerTest", "afex", "emmeans", "sjPlot",
...
The conditional $R^2$ of the model describes the proportion of variance explained by both fixed and random effects, and is $R^2=$ `r format(h2b_r2, digits = 2)`.
...
The conditional $R^2$ of the model describes the proportion of variance explained by both fixed and random effects, and is $R^2=$ `r format(h2c_r2, digits = 2)`.
