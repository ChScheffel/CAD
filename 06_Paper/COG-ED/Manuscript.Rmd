...
```{r import, echo=FALSE, message=FALSE, warning=FALSE}
  ...
  # create a new data frame for the data that is being used for reaction time analysis
  # (we cannot exclude trials from the main data frame because the computation of d prime depends on hit-ratios, not reaction time)
