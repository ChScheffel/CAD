...
```{r Hypothesis_2b, echo=FALSE, message=FALSE, warning=FALSE}
  ...
  write.csv2(te.norm.fixef, file = "S4_te.norm.fixef.csv")
  write.csv2(te.norm.ranef, file = "S4_te.norm.ranef.csv")
...
table withterm/parameter - Beta - SE - p-value - random effects (SD)
huxtable?
