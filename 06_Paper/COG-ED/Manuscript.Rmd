...
Second, we will estimate a random slopes model of n-back level (level 1, fixed and random factor: 1-back, 2-back, 3-back, 4-back) predicting SV nested within subjects.
