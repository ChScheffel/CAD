...
# would it be possible to compare the originally calculated SV with our new one?
...
```{r Hypothesis_1a, echo=FALSE, message=FALSE, warning=FALSE}
  ...
  # FIXME: What makes this transformation necessary? Why per n-back level separately? Is this the standard procedure?
  # FIXME: for z-transformation we could use function scale: 
  
  # # create new variables
  # dprime$falsealarmrate.z = dprime$hitrate.z =NA
  # for (i in 1:4) {
