...
Participants indicate via button press whether the current stimulus is the same as *n* stimuli before, with *n* being the level of difficulty between one and six [@Mackworth1959]; and are asked to respond as quickly and as accurately as possible.
...
This is repeated five more times, with each adjustment of the 1-back reward being half as big as in the previous step, while the reward for the more difficult level remains fixed at 2\$.
...
Additionally, we will compare the ED behaviour of participants regarding the n-back task and an emotion regulation task, the full results of which will be published in a second Registered Report.
...
##Power analysis
A sample size analysis with GPower [@Faul2007; @Faul2009], using the RT data from the n-back task, indicated that we should collect data from at least 40 participants, assuming $f=0.27$, $\alpha=.05$, $\beta=.80$, and no correlation between levels.
