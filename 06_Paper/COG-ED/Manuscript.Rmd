...
In each pair, the level chosen by the participant at least two out of three times will be used as the level with a flexible value, which starts at 1€ and is changed in every iteration.
...
At the end of each level, participants fill out the NASA-TLX on a tablet.
