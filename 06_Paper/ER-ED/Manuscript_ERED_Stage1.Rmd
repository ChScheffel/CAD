...
```
Figure:
```{r FigSubjArousalViewPilot, echo=FALSE, message=FALSE, warning=FALSE, fig.cap="Subjective arousal ratings for the conditions "Active viewing - neutral" and "Active viewing - negative"}
