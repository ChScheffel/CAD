...
`r afex::nice(SubjArousalView_pilot_aov) %>% knitr::kable(x = .)` 
$BF10=$ `r round(extractBF(SubjArousalView_pilot_BF)$bf, digits = 2)`
...
ANOVA:
`r afex::nice(SubjArousalReg_pilot_aov) %>% knitr::kable(x = .)`
$BF10=$ `r round(extractBF(SubjArousalReg_pilot_BF)$bf, digits = 2)`
...
*Corrugator*:
ANOVA: 
`r afex::nice(EMGCorrView_pilot_aov) %>% knitr::kable(x = .)`
$BF10=$ `r round(extractBF(EMGCorrView_pilot_BF)$bf, digits = 2)`
...
*Levator*:
ANOVA: 
`r afex::nice(EMGLevView_pilot_aov) %>% knitr::kable(x = .)`
$BF10=$ `r round(extractBF(EMGLevView__pilotBF)$bf, digits = 2)`
...
*Corrugator*:
ANOVA: 
`r afex::nice(EMGCorrReg_pilot_aov) %>% knitr::kable(x = .)`
$BF10=$ `r round(extractBF(EMGCorrReg_pilot_BF)$bf, digits = 2)`
...
*Levator*:
ANOVA: 
`r afex::nice(EMGLevReg_pilot_aov) %>% knitr::kable(x = .)`
$BF10=$ `r round(extractBF(EMGLevReg_pilot_BF)$bf, digits = 2)`
...
ANOVA:
`r afex::nice(SubjEffort_pilot_aov) %>% knitr::kable(x = .)`
$BF10=$ `r round(extractBF(SubjEffort_pilot_BF)$bf, digits = 2)`
