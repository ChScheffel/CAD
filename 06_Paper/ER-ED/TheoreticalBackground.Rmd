...
<!--CS: Mit dem Teil bin ich noch nicht ganz zufrieden, freue mich über Anmerkungen, wie man das evtl. strukturieren kann! AS: FInde den Teil eigentlich ganz gut gelungen, aber ich bin leider auch nicht os im Thema ER drin. -->
...
Similar to other psychological domains such as attention and goal pursuit, *maladaptive* now refers to inflexible strategy use or the use of strategies that are hindering the achievement of goals [@Aldao2015].
In contrast, *adaptive* ER requires having a large repertoire of ER strategies to choose from [@Aldao2015] and choosing the strategy that is useful for goal achievement in a particular situation.
...
Effort in particular appeared to be the main factor in ER choice behaviour <!-- chekcne pob bei NHB AE oder BE genutzt wird -->in our previous work [@Scheffel2021].
