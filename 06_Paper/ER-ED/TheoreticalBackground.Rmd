...
First, adaptive flexible ER requires having a large repertoire of ER strategies [@Aldao2015]. <!--JZ: Hier mit "First" weiterzumachen, ist nicht so sinnvoll, weil der vorherige Satz keine Argumentation einleitet, die nun durch first, second, etc. ausgeführt werden soll-->
