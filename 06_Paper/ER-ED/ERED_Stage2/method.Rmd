...
*Subjective values of emotion regulation strategies.* <br> For each ER strategy, SVs were calculated as follows: first, the SV of the flexible strategy was set to 1, because in the first comparison of each pairing where the same value was offered for both strategies, so the flexible strategy was the preferred strategy in each pairing.
