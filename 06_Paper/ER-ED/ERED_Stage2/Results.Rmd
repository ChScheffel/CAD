...
In addition, a positive association was also found between self-control and SVs (`r papaja::apa_print(MLM_3)$full_result$SC_gmc`).<!--JZ: Auch hier gern die Richtung des Effekts mit hinschreiben-->
