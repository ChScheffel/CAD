...
Interestingly, utility rating showed the greatest effect size of all predictors ($f^{2}=$ `r papaja::printnum(H5_M2_table[4,5], digits = 3)`), indicating that utility rating explained `r papaja::printnum(H5_M2_table[4,5]*100, digits = 1)`% of variance in SVs.<!--JZ: Mir wurde mal die Verwendung von Worten wie "interestingly" im Ergebnisteil angekreidet, also die Bewertung vielleicht bis zum Diskussionsteil aufheben-->
