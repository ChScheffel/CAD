...
Of these, $N=`r sum(data_survey[,"files_coged_complete"] == 2)`$ participated in the first laboratory session and $N=`r sum(data_survey[,"followup_ered_complete"] == 2)`$ completed the second laboratory session.
