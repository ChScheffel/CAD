...
The predictors effort rating (`r papaja::apa_print(MLM_2)$full_result$effort_cwc`), utility rating (`r papaja::apa_print(MLM_2)$full_result$effort_cwc`), and *Corrugator* activity (`r papaja::apa_print(MLM_2)$full_result$effort_cwc`) showed a significant association with SVs.
