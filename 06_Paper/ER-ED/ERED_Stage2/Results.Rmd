...
Here, `r round((54/119)*100, digits = 1)` percent stated that they chose the strategy that was easiest for them to implement.
...
In sum, $n=$ `r  papaja::printnum(sum(data_SV$sv == 1))` participants had one SV of 1.0, indicating a clear preference for one ER strategy.
