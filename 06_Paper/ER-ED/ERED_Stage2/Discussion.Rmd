...
In addition, a wide variety of factors that influence the choice of strategies in specific situations were examined[@Scheffel2021;@Sheppes2011;@Sheppes2014;@Wilms2020;@Young2020;@Matthews2021], including intensity of the situation and effort.
However, these factors have often been studied separately.
Only rarely have effects of the factors been studied in combination[@Young2020].
Moreover, the usual paradigms used in ER choice research (e.g., Sheppes et al.[@Sheppes2011]) can only estimate how a factor tends to drive the choice in one direction or the other.
...
This may be due to the fact that in laboratory studies, the choice options are often predetermined by the design of the experiment [@Sheppes2011;@Sheppes2014;@Scheffel2021].
...
If it is determined that the regulation goal is not being achieved, the ER strategy can be maintained, stopped or switched[@Gross2015].
Importantly, information about the effects of implementing ER strategies influences the choice of ER strategies in future situations, due to contextual feedback even changes the context[@Gross2015;@AldaoChristensen2015;@Murphy2018;@Sheppes2020].
This means that for studies on ER Choice, not only situational factors should be taken into account, but also contextual factors[@Murphy2018].
For example, Murphy and Young[@Murphy2018] could show that in a classic ER choice paradigm[@Sheppes2011], strategy selection was significantly influenced by strategy selection and negative affect of the preceding trial.
