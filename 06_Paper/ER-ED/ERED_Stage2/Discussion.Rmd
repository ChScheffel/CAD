...
One possible reason for this could be that muscle activity provides direct feedback on the effectiveness of the current stragey, much more direct than, for example, the subjective arousal rating at the end of each experimental block.
