...
Almost all participants showed an absolut preference for one strategy, indicated by a SV of 1. 

 
Subjective effort, utility, and *Corrugator* muscle activity significantly predicted individual SVs.
Contrary to our hypothesis, utility was the best predictor for individual SVs, explaining `r papaja::printnum(H5_M2_table[4,5]*100, digits = 1)` percent of variance in SVs.
However, individual SVs did not show associations with ER flexibility.
