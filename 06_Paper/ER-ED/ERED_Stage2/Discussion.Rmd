...
The individual SVs calculated in our CAD paradigm were assessed in the laboratory in a single situation, which by definition represents a state.
...
It should also be noted that the calculation of individual SVs in our CAD paradigm are always relative to the alternative strategies that were available (see also [Limitations](#Limitations)).
Therefore, SVs may vary if different reference strategies are used, but it is very likely that SVs are highly correlated across situations with similar demands and goals. 
...
However, this would require the measurement of SVs at two or more points in time, ideally in both the same and different contexts (e.g., changing valence of stimuli and add further ER strategies). 
Thus, temporal and situational variance could be separated and the stable, habitual part of the subjective values of the individual strategies could be determined.
In the future, SVs should therefore be collected across similar situations. 
