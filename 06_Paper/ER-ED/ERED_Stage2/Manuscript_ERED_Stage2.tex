...
Post-hoc test showed significantly reduced subjective arousal after use of distraction (\(\eta_{p}^{2}=0.05, [0.02, 1.00]\), \(BF_{10}=\)\(1.68 \times 10^{2}\)), distancing (\(\eta_{p}^{2}=0.03, [0.01, 1.00]\), \(BF_{10}=\)\(6.30 \times 10^{1}\)), and suppression (\(\eta_{p}^{2}=0.02, [0.00, 1.00]\), \(BF_{10}=\)\(1.97\)) compared with active viewing.
However, there were no significant differences between strategies (all \(p>.05\)).
To explore whether ER strategies reduce physiological responding, we conducted another two rmANOVAS comparing \emph{Corrugator} activity and \emph{Levator} activity of four the strategies.
