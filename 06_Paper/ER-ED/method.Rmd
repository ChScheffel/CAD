...
The procedure of the discounting followed the COG-ED paradigm by Westbrook et al. [-@Westbrook2013] with major change (see [1.1](##adapting an effort discounting paradigm)).
...
Because there is no strategy that is objectively more difficult, all comparisons began with the option "1 EUR for strategy A or 1 EUR for strategy B".
