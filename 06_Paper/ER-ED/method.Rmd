...
for (i in 1:length(datalist_EMG)) {
  ...
  tmp = data.frame(datalist_EMG[[i]][["participant"]], 
...
aov_arousalView = afex::aov_ez(id = "ID",
                           dv = "arousal",
                           data = arousal_view,
                           within = "block",
                           fun_aggregate = mean) 
afex::nice(aov_arousalView, es = "pes")
...
# figure
ggplot2::ggplot(arousal_view, aes(x = block, y = arousal))+
...
aov_arousalReg = afex::aov_ez(id = "ID",
                              dv = "arousal",
                              data = arousal_reg,
                              within = "block",
                              fun_aggregate = mean)
...
# figure
ggplot2::ggplot(arousal_reg, aes(x = block, y = arousal))+
  geom_boxplot(width = 0.7, position = position_dodge(0.8))+
  scale_x_discrete(name = "Strategy", 
...
# figure
ggplot2::ggplot(effort_reg, aes(x = block, y = effort))+
  geom_boxplot(width = 0.7, position = position_dodge(0.8))+
  scale_x_discrete(name = "Strategy", 
                   limits = c("view_neg", "distraction", "distancing", "suppression"),
                   labels = c("View", "Distraction", "Distancing", "Suppression"))+
