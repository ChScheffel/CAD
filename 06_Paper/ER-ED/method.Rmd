...
datalist_ER = lapply(list.files(here("04_RawData", "Pilot", "ER_ED"), pattern = '.*ER.*csv', full.names = TRUE),
                          read.csv, stringsAsFactors = FALSE, header = TRUE)
  
datalist_ED = lapply(list.files(here("04_RawData", "Pilot", "ER_ED"), pattern = '.*_ED.*csv', full.names = TRUE),
                          read.csv, stringsAsFactors = FALSE, header = TRUE)
```
