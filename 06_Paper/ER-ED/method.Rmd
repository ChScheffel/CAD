...
SubjArousalReg_con$etasq <- format(effectsize::t_to_eta2(t = SubjArousalReg_con$t.ratio,
...
SubjEffort_con$etasq <- format(effectsize::t_to_eta2(t = SubjEffort_con$t.ratio,
...
# figure
FigPilot3 = ggplot2::ggplot(Ratings_reg, aes(x = block, y = effort))+
  geom_boxplot(width = 0.7, position = position_dodge(0.8))+
  scale_x_discrete(name = "Strategy", 
                   limits = c("view_neg", "distraction", "distancing", "suppression"),
                   labels = c("View", "Distraction", "Distancing", "Suppression"))+
