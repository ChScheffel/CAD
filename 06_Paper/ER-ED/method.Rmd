...
aov.arousal = afex::aov_ez(id = "ID",    #ATTENTION: needs pagacke "afex"
                      dv = "arousal",
                      data = data_ER,
                      within = "block",
                      fun_aggregate = mean) 
...
# compute posthoc tests for both within measures
posthoc_test_strategy = emmeans::emmeans(aov.arousal$aov, specs = "block")
pairs(posthoc_test_strategy, adjust = "bonferroni")
```