...
SubjArousalView_con$etasq <- format(effectsize::t_to_eta2(t = SubjArousalView_con$t.ratio,
...
# figure
FigPilot1=ggplot2::ggplot(Ratings_view, aes(x = block, y = arousal))+
...
SubjArousalReg_con$etasq <- format(effectsize::t_to_eta2(t = SubjArousalReg_con$t.ratio, df_error = SubjArousalReg_con$df, ci = 0.95), digits = 2)

# Figure to visualize arousal ratings

# figure
FigPilot2 = ggplot2::ggplot(Ratings_reg, aes(x = block, y = arousal))+
  geom_boxplot(width = 0.7, position = position_dodge(0.8))+
  scale_x_discrete(name = "Strategy", 
