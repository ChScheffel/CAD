...
After each block, participants retrospectively rated their subjective emotional arousal ("not at all aroused" to "very highly aroused"), their subjective effort ("not very exhausting" to "very exhausting"), and the utility of each strategy ("not useful at all" to "very useful") on a continuous scale using a slider on screen.
