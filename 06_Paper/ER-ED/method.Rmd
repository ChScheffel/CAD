...
Bipolar facial electromyography (EMG) will be measured for *corrugator supercilii* and *levator labii* as indices of affective valence (Bradley & Lang, 2000). <!-- Quelle noch einfügen -->
Two passive surface Ag/AgCl electrodes (8 mm inner diameter, 10 mm distance between electrodes) will be placed over each left muscle according to the guidelines of Fridlund and Cacioppo (1986). <!-- Quelle einfügen -->
...
<!-- somehow refer to the Design Table here, where everything is detailed -->
...
To examine the effects of the three ER strategies on facial EMG, another rmANOVA with the factor strategy (active viewing, distraction, distancing, and suppression) for *corrugator* and *levator* activity will be conducted.
<!-- hier werden HE across neg + neu Bedingungen angeschaut, ist das korrekt? -->
<!-- Habe den Text oben sprachlich vereinheitlicht, weil ich es sonst schwer zu lesen fand. -->
