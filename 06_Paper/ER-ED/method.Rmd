...
Firstly, intraclass correlation (ICC) will be calculated on the basis of the null model.
Secondly, a random slopes model of SVs including subjective effort (effort ratings), subjective arousal (arousal ratings), and physiological arousal (*corrugator* activity and *levator* activity) as level-1-predictor will be specified.
$$
