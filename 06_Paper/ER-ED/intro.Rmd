...
Different strategies can be used to regulate emotions.
So called antecedent-focused strategies, i.e., situation selection, situation modification, attentional deployment, and cognitive change take effect early in the emotion generation process.
The strategy response modification, in contrast, takes place late in the process and is therefore conceptualized as response-focused strategy [@Gross1998antecedent].
