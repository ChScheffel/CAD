...
[...]
<!-- Als Überleitung: Maladaptive ER Strategien zu ER Flexibility -->
...
This selection of strategies is influenced by numerous facotrs.
For example, it was shown that the intensity of a stimulus or situation plays a role in the choice [@Sheppes2011]. 
Higher intensity of the stimulus leads to a choice of rather disengaging strategies, like distraction.

<!-- Weitere Einflussfaktoren aufzuählen zu  ER Choice -->
[...]

What was missing in this research so far was the information regarding the strategy not chosen. 
People choose a strategy that they prefer, for whatever reason. 
However, nothing is revealed about the strategy that is not chosen.
On the one hand, it could be possible that the chosen strategy is the clear preference, the unchosen strategy is not a realistic option for the individual. 
...
This leads to the question of how individual subjective values of ER strategies are characterized an how one can determine them. 
Individual subjective values (SV) of effortful tasks have been quantified using the cognitive effort discounting paradigm (COG-ED) [@Westbrook2013]. 
